...
ggplot(subset(LAPOP_2021dic,
  ...
  geom_boxplot() +
  ggtitle("Confianza en elecciones por edad, 2021") +
...
ggplot(subset(subset(LAPOP_2021dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por género, 2021") +
  xlab("Género") +
...
ggplot(subset(subset(LAPOP_2021dic,
  ...
  ggtitle("Confianza en elecciones por macrorregión, 2021") +
  xlab("Macrorregión") +
  ylab("Conteo porcentual") +
  labs(fill = "Confianza")
...
ggplot(subset(subset(LAPOP_2021dic,
  ...
  ggtitle("Confianza en elecciones por preferencia por la democracia, 2021") +
...
ggplot(subset(subset(LAPOP_2021dic,
  ...
  ggtitle("Confianza en elecciones por autoidentificación étnica, 2021") +
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  ggtitle("Confianza en elecciones por macrorregión, 2023") +
  xlab("Macrorregión") +
  ylab("Conteo porcentual") +
  labs(fill = "Confianza")
...
ggplot(subset(LAPOP_2023dic,
  ...
  ggtitle("Confianza en elecciones por ámbito, 2023") +
  xlab("Ámbito") +
  ylab("Conteo porcentual") +
  labs(fill = "Confianza")
...
ggplot(subset(LAPOP_2023dic,
  ...
  geom_boxplot() +
  ggtitle("Confianza en elecciones por edad, 2023") +
  xlab("Confianza en elecciones") +
  ylab("Edad") +
  theme(legend.position = "none")
#Checking if distribution is apparently different
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por género, 2023") +
  xlab("Género") +
  ylab("Conteo porcentual")
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por mayor problema, 2023") +
  xlab("Mayor problema") +
  ylab("Conteo porcentual")
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por escala ideológica, 2023") +
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por percepción de conteo justo, 2023") +
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por percepción de secreto del voto, 2023") +
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por satisfacción con democracia, 2023") +
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por percepción \nde corrupción en funcionarios, 2023") +
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por opción de voto el 2021, 2023") +
  xlab("Opción de voto el 2021, 2023") +
  ylab("Conteo porcentual")
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por nivel educativo, 2023") +
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por religión, 2023") +
  xlab("Religión") +
  ylab("Conteo porcentual")
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por ingreso familiar mensual, 2023") +
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  labs(fill = "Confianza") +
  ggtitle("Confianza en elecciones por si alcanzan los ingresos, 2023") +
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  ggtitle("Confianza en elecciones por autoidentificación étnica, 2023") +
  xlab("Autoidentificación étnica") +
  ylab("Conteo porcentual") +
  labs(fill = "Confianza")
...
ggplot(subset(subset(LAPOP_2023dic,
  ...
  ggtitle("Confianza en elecciones por lengua materna, 2023") +
  xlab("Lengua materna") +
  ylab("Conteo porcentual") +
  labs(fill = "Confianza")
